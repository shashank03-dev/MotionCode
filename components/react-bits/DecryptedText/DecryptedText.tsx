...
/* eslint-disable react-hooks/set-state-in-effect -- Vendored React Bits
   component kept verbatim; its mount effects seed display state from props.
   Rewriting that pattern would fork the upstream source we intentionally mirror. */

// Vendored from React Bits (DecryptedText, TS+CSS variant).
// Only change from upstream: import 'motion/react' -> 'framer-motion'
// (this project already depends on framer-motion v12), plus the
// "use client" directive above for the Next.js App Router.
